...
def generate_private_key(): 
	...
	"""
	#print('\npriv')
	#print(binascii.hexlify(os.urandom(32)).decode('utf-8').upper())
...
def private_key_to_public_key(private_key):
	...
	pk2 = binascii.hexlify(SEC1Encoder.encode_public_key(secp256k1.G * int(private_key, 16), compressed=False))
